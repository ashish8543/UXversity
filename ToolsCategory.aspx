<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ToolsCategory.aspx.cs" Inherits="ToolsCategory" %>
                    ...
                    <ItemTemplate>
                        <div class="col-lg-4 col-md-6 mb-4 mb-lg-5">
                            <div class="service_item">
                                <img src='<%# Eval("Pic") %>' alt="" class="img-fluid">
                                <h4><%# Eval("CatName") %></h4>

                                <a href="Tools.aspx?cid=<%# Eval("Id") %>" class="primary_btn button-contactForm">View Tools</a>
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
